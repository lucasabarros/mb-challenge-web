<template>
  <div class="step-container">
    ...
    <h2 class="title">
      {{
        formData.registrationType === "pf" ? "Pessoa Física" : "Pessoa Jurídica"
      }}
    </h2>
    ...
    <template v-if="formData.registrationType === 'pf'">
      ...
      <BaseInput
        ...
        required
        autocomplete="bdate"
        ariaDescribedBy="birthDateError"
    ...
    <template v-else>
      <BaseInput
        ...
        ariaDescribedBy="corporateNameError"
      ...
      <BaseInput
        ...
        required
        autocomplete="bdate"
        ariaDescribedBy="foundingDateError"
